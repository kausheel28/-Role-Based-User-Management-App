...
const ScheduleInterviewModal: React.FC<ScheduleInterviewModalProps> = ({ isOpen, onClose }) => {
  const [formData, setFormData] = useState<ScheduleInterviewForm>({
    candidate_id: 0,
    interviewer_name: '',
    scheduled_at: '',
    duration_minutes: 60,
  ...
  const createInterviewMutation = useMutation({
    mutationFn: (data: ScheduleInterviewForm) => interviewsApi.createInterview(data),
    onSuccess: () => {
  ...
  const handleInputChange = (field: keyof ScheduleInterviewForm, value: string | number) => {
        ...
        <div className="mt-3">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <h3 className="ml-3 text-lg font-medium text-gray-900">Schedule Interview</h3>
            </div>
            <button
              onClick={onClose}
